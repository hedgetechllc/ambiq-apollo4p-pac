#[doc = "Register `TEX0STRIDE` reader"]
pub type R = crate::R<Tex0strideSpec>;
#[doc = "Register `TEX0STRIDE` writer"]
pub type W = crate::W<Tex0strideSpec>;
...
#[repr(u8)]
pub enum Imgmode {
    #[doc = "0: Texture mapping: rotate, resize and distort a bitmap image. Nearest neighbor sampling."]
    Pointsample = 0,
...
impl ImgmodeR {
    ...
    #[doc = "Texture mapping: rotate, resize and distort a bitmap image. Nearest neighbor sampling."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imgstrd(&mut self) -> ImgstrdW<Tex0strideSpec> {
        ImgstrdW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Image Mode"]
    #[inline(always)]
    #[must_use]
    pub fn imgmode(&mut self) -> ImgmodeW<Tex0strideSpec> {
        ImgmodeW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Image Format"]
    #[inline(always)]
    #[must_use]
    pub fn imgfmt(&mut self) -> ImgfmtW<Tex0strideSpec> {
        ImgfmtW::new(self, 24)
    }
}
#[doc = "Image 0 mode and stride.\n\nYou can [`read`](crate::Reg::read) this register and get [`tex0stride::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tex0stride::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tex0strideSpec;
impl crate::RegisterSpec for Tex0strideSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tex0stride::R`](R) reader structure"]
impl crate::Readable for Tex0strideSpec {}
#[doc = "`write(|w| ..)` method takes [`tex0stride::W`](W) writer structure"]
impl crate::Writable for Tex0strideSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TEX0STRIDE to value 0"]
impl crate::Resettable for Tex0strideSpec {
