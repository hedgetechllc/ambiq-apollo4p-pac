#[doc = "Register `TEX1STRIDE` reader"]
pub type R = crate::R<Tex1strideSpec>;
#[doc = "Register `TEX1STRIDE` writer"]
pub type W = crate::W<Tex1strideSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imgstrd(&mut self) -> ImgstrdW<Tex1strideSpec> {
        ImgstrdW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Image Mode"]
    #[inline(always)]
    #[must_use]
    pub fn imgmode(&mut self) -> ImgmodeW<Tex1strideSpec> {
        ImgmodeW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Image Format"]
    #[inline(always)]
    #[must_use]
    pub fn imgfmt(&mut self) -> ImgfmtW<Tex1strideSpec> {
        ImgfmtW::new(self, 24)
    }
}
#[doc = "Image 1 mode and stride.\n\nYou can [`read`](crate::Reg::read) this register and get [`tex1stride::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tex1stride::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tex1strideSpec;
impl crate::RegisterSpec for Tex1strideSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tex1stride::R`](R) reader structure"]
impl crate::Readable for Tex1strideSpec {}
#[doc = "`write(|w| ..)` method takes [`tex1stride::W`](W) writer structure"]
impl crate::Writable for Tex1strideSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TEX1STRIDE to value 0"]
impl crate::Resettable for Tex1strideSpec {
