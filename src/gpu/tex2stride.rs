#[doc = "Register `TEX2STRIDE` reader"]
pub type R = crate::R<Tex2strideSpec>;
#[doc = "Register `TEX2STRIDE` writer"]
pub type W = crate::W<Tex2strideSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn imgstrd(&mut self) -> ImgstrdW<Tex2strideSpec> {
        ImgstrdW::new(self, 0)
    }
    #[doc = "Bits 16:23 - image mode"]
    #[inline(always)]
    #[must_use]
    pub fn imgmode(&mut self) -> ImgmodeW<Tex2strideSpec> {
        ImgmodeW::new(self, 16)
    }
    #[doc = "Bits 24:31 - image format"]
    #[inline(always)]
    #[must_use]
    pub fn imgfmt(&mut self) -> ImgfmtW<Tex2strideSpec> {
        ImgfmtW::new(self, 24)
    }
}
#[doc = "Image 2 mode and stride.\n\nYou can [`read`](crate::Reg::read) this register and get [`tex2stride::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tex2stride::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tex2strideSpec;
impl crate::RegisterSpec for Tex2strideSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tex2stride::R`](R) reader structure"]
impl crate::Readable for Tex2strideSpec {}
#[doc = "`write(|w| ..)` method takes [`tex2stride::W`](W) writer structure"]
impl crate::Writable for Tex2strideSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TEX2STRIDE to value 0"]
impl crate::Resettable for Tex2strideSpec {
