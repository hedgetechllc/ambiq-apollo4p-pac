#[doc = "Register `EMONCFG1` reader"]
pub type R = crate::R<Emoncfg1Spec>;
#[doc = "Register `EMONCFG1` writer"]
pub type W = crate::W<Emoncfg1Spec>;
...
impl From<Emonsel1> for u8 {
    #[inline(always)]
    fn from(variant: Emonsel1) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Emonsel1 {
    type Ux = u8;
}
impl crate::IsEnum for Emonsel1 {}
#[doc = "Field `EMONSEL1` reader - Power modes for incrementing the counter"]
pub type Emonsel1R = crate::FieldReader<Emonsel1>;
impl Emonsel1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Emonsel1> {
        match self.bits {
            0 => Some(Emonsel1::Never),
            1 => Some(Emonsel1::Always),
            2 => Some(Emonsel1::Mcusleep),
            3 => Some(Emonsel1::Mcudeepsleep),
            4 => Some(Emonsel1::Dsp0on),
            5 => Some(Emonsel1::Dsp1on),
            6 => Some(Emonsel1::Adcon),
            7 => Some(Emonsel1::Audpbon),
            8 => Some(Emonsel1::Audrecon),
            9 => Some(Emonsel1::I2s0on),
            10 => Some(Emonsel1::I2s1on),
            11 => Some(Emonsel1::Pdm0on),
            12 => Some(Emonsel1::Pdm1on),
            13 => Some(Emonsel1::Pdm2on),
            14 => Some(Emonsel1::Pdm3on),
            15 => Some(Emonsel1::Audadcon),
            16 => Some(Emonsel1::Cryptoon),
            17 => Some(Emonsel1::Dbgon),
            18 => Some(Emonsel1::Dispon),
            19 => Some(Emonsel1::Dispphyon),
            20 => Some(Emonsel1::Dspaon),
            21 => Some(Emonsel1::Gfxon),
            22 => Some(Emonsel1::Uart0on),
            23 => Some(Emonsel1::Uart1on),
            24 => Some(Emonsel1::Uart2on),
            25 => Some(Emonsel1::Uart3on),
            26 => Some(Emonsel1::Iom0on),
            27 => Some(Emonsel1::Iom1on),
            28 => Some(Emonsel1::Iom2on),
            29 => Some(Emonsel1::Iom3on),
            30 => Some(Emonsel1::Reserved30),
            31 => Some(Emonsel1::Reserved31),
            32 => Some(Emonsel1::Iom4on),
            33 => Some(Emonsel1::Iom5on),
            34 => Some(Emonsel1::Iom6on),
            35 => Some(Emonsel1::Iom7on),
            36 => Some(Emonsel1::Ioson),
            37 => Some(Emonsel1::Mspi0on),
            38 => Some(Emonsel1::Mspi1on),
            39 => Some(Emonsel1::Mspi2on),
            40 => Some(Emonsel1::Sdioon),
            41 => Some(Emonsel1::Usbon),
            42 => Some(Emonsel1::Usbphyon),
            _ => None,
        }
    }
    ...
    pub fn is_usbphyon(&self) -> bool {
        *self == Emonsel1::Usbphyon
    }
}
#[doc = "Field `EMONSEL1` writer - Power modes for incrementing the counter"]
pub type Emonsel1W<'a, REG> = crate::FieldWriter<'a, REG, 8, Emonsel1>;
impl<'a, REG> Emonsel1W<'a, REG>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn emonsel1(&mut self) -> Emonsel1W<Emoncfg1Spec> {
        Emonsel1W::new(self, 0)
    }
}
#[doc = "The counter increments when the counter is enabled and the mode selected here matches the power mode.\n\nYou can [`read`](crate::Reg::read) this register and get [`emoncfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`emoncfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Emoncfg1Spec;
impl crate::RegisterSpec for Emoncfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emoncfg1::R`](R) reader structure"]
impl crate::Readable for Emoncfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`emoncfg1::W`](W) writer structure"]
impl crate::Writable for Emoncfg1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EMONCFG1 to value 0"]
impl crate::Resettable for Emoncfg1Spec {
