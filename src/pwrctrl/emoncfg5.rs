#[doc = "Register `EMONCFG5` reader"]
pub type R = crate::R<Emoncfg5Spec>;
#[doc = "Register `EMONCFG5` writer"]
pub type W = crate::W<Emoncfg5Spec>;
...
impl From<Emonsel5> for u8 {
    #[inline(always)]
    fn from(variant: Emonsel5) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Emonsel5 {
    type Ux = u8;
}
impl crate::IsEnum for Emonsel5 {}
#[doc = "Field `EMONSEL5` reader - Power modes for incrementing the counter"]
pub type Emonsel5R = crate::FieldReader<Emonsel5>;
impl Emonsel5R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Emonsel5> {
        match self.bits {
            0 => Some(Emonsel5::Never),
            1 => Some(Emonsel5::Always),
            2 => Some(Emonsel5::Mcusleep),
            3 => Some(Emonsel5::Mcudeepsleep),
            4 => Some(Emonsel5::Dsp0on),
            5 => Some(Emonsel5::Dsp1on),
            6 => Some(Emonsel5::Adcon),
            7 => Some(Emonsel5::Audpbon),
            8 => Some(Emonsel5::Audrecon),
            9 => Some(Emonsel5::I2s0on),
            10 => Some(Emonsel5::I2s1on),
            11 => Some(Emonsel5::Pdm0on),
            12 => Some(Emonsel5::Pdm1on),
            13 => Some(Emonsel5::Pdm2on),
            14 => Some(Emonsel5::Pdm3on),
            15 => Some(Emonsel5::Audadcon),
            16 => Some(Emonsel5::Cryptoon),
            17 => Some(Emonsel5::Dbgon),
            18 => Some(Emonsel5::Dispon),
            19 => Some(Emonsel5::Dispphyon),
            20 => Some(Emonsel5::Dspaon),
            21 => Some(Emonsel5::Gfxon),
            22 => Some(Emonsel5::Uart0on),
            23 => Some(Emonsel5::Uart1on),
            24 => Some(Emonsel5::Uart2on),
            25 => Some(Emonsel5::Uart3on),
            26 => Some(Emonsel5::Iom0on),
            27 => Some(Emonsel5::Iom1on),
            28 => Some(Emonsel5::Iom2on),
            29 => Some(Emonsel5::Iom3on),
            30 => Some(Emonsel5::Reserved30),
            31 => Some(Emonsel5::Reserved31),
            32 => Some(Emonsel5::Iom4on),
            33 => Some(Emonsel5::Iom5on),
            34 => Some(Emonsel5::Iom6on),
            35 => Some(Emonsel5::Iom7on),
            36 => Some(Emonsel5::Ioson),
            37 => Some(Emonsel5::Mspi0on),
            38 => Some(Emonsel5::Mspi1on),
            39 => Some(Emonsel5::Mspi2on),
            40 => Some(Emonsel5::Sdioon),
            41 => Some(Emonsel5::Usbon),
            42 => Some(Emonsel5::Usbphyon),
            _ => None,
        }
    }
    ...
    pub fn is_usbphyon(&self) -> bool {
        *self == Emonsel5::Usbphyon
    }
}
#[doc = "Field `EMONSEL5` writer - Power modes for incrementing the counter"]
pub type Emonsel5W<'a, REG> = crate::FieldWriter<'a, REG, 8, Emonsel5>;
impl<'a, REG> Emonsel5W<'a, REG>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn emonsel5(&mut self) -> Emonsel5W<Emoncfg5Spec> {
        Emonsel5W::new(self, 0)
    }
}
#[doc = "The counter increments when the counter is enabled and the mode selected here matches the power mode.\n\nYou can [`read`](crate::Reg::read) this register and get [`emoncfg5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`emoncfg5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Emoncfg5Spec;
impl crate::RegisterSpec for Emoncfg5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emoncfg5::R`](R) reader structure"]
impl crate::Readable for Emoncfg5Spec {}
#[doc = "`write(|w| ..)` method takes [`emoncfg5::W`](W) writer structure"]
impl crate::Writable for Emoncfg5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EMONCFG5 to value 0"]
impl crate::Resettable for Emoncfg5Spec {
