#[doc = "Register `EMONCFG0` reader"]
pub type R = crate::R<Emoncfg0Spec>;
#[doc = "Register `EMONCFG0` writer"]
pub type W = crate::W<Emoncfg0Spec>;
...
impl From<Emonsel0> for u8 {
    #[inline(always)]
    fn from(variant: Emonsel0) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Emonsel0 {
    type Ux = u8;
}
impl crate::IsEnum for Emonsel0 {}
#[doc = "Field `EMONSEL0` reader - Power modes for incrementing the counter"]
pub type Emonsel0R = crate::FieldReader<Emonsel0>;
impl Emonsel0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Emonsel0> {
        match self.bits {
            0 => Some(Emonsel0::Never),
            1 => Some(Emonsel0::Always),
            2 => Some(Emonsel0::Mcusleep),
            3 => Some(Emonsel0::Mcudeepsleep),
            4 => Some(Emonsel0::Dsp0on),
            5 => Some(Emonsel0::Dsp1on),
            6 => Some(Emonsel0::Adcon),
            7 => Some(Emonsel0::Audpbon),
            8 => Some(Emonsel0::Audrecon),
            9 => Some(Emonsel0::I2s0on),
            10 => Some(Emonsel0::I2s1on),
            11 => Some(Emonsel0::Pdm0on),
            12 => Some(Emonsel0::Pdm1on),
            13 => Some(Emonsel0::Pdm2on),
            14 => Some(Emonsel0::Pdm3on),
            15 => Some(Emonsel0::Audadcon),
            16 => Some(Emonsel0::Cryptoon),
            17 => Some(Emonsel0::Dbgon),
            18 => Some(Emonsel0::Dispon),
            19 => Some(Emonsel0::Dispphyon),
            20 => Some(Emonsel0::Dspaon),
            21 => Some(Emonsel0::Gfxon),
            22 => Some(Emonsel0::Uart0on),
            23 => Some(Emonsel0::Uart1on),
            24 => Some(Emonsel0::Uart2on),
            25 => Some(Emonsel0::Uart3on),
            26 => Some(Emonsel0::Iom0on),
            27 => Some(Emonsel0::Iom1on),
            28 => Some(Emonsel0::Iom2on),
            29 => Some(Emonsel0::Iom3on),
            30 => Some(Emonsel0::Reserved30),
            31 => Some(Emonsel0::Reserved31),
            32 => Some(Emonsel0::Iom4on),
            33 => Some(Emonsel0::Iom5on),
            34 => Some(Emonsel0::Iom6on),
            35 => Some(Emonsel0::Iom7on),
            36 => Some(Emonsel0::Ioson),
            37 => Some(Emonsel0::Mspi0on),
            38 => Some(Emonsel0::Mspi1on),
            39 => Some(Emonsel0::Mspi2on),
            40 => Some(Emonsel0::Sdioon),
            41 => Some(Emonsel0::Usbon),
            42 => Some(Emonsel0::Usbphyon),
            _ => None,
        }
    }
    ...
    pub fn is_usbphyon(&self) -> bool {
        *self == Emonsel0::Usbphyon
    }
}
#[doc = "Field `EMONSEL0` writer - Power modes for incrementing the counter"]
pub type Emonsel0W<'a, REG> = crate::FieldWriter<'a, REG, 8, Emonsel0>;
impl<'a, REG> Emonsel0W<'a, REG>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn emonsel0(&mut self) -> Emonsel0W<Emoncfg0Spec> {
        Emonsel0W::new(self, 0)
    }
}
#[doc = "The counter increments when the counter is enabled and the mode selected here matches the power mode.\n\nYou can [`read`](crate::Reg::read) this register and get [`emoncfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`emoncfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Emoncfg0Spec;
impl crate::RegisterSpec for Emoncfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emoncfg0::R`](R) reader structure"]
impl crate::Readable for Emoncfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`emoncfg0::W`](W) writer structure"]
impl crate::Writable for Emoncfg0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EMONCFG0 to value 0"]
impl crate::Resettable for Emoncfg0Spec {
