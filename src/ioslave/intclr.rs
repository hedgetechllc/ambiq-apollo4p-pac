...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsize(&mut self) -> FsizeW<IntclrSpec> {
        FsizeW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fovfl(&mut self) -> FovflW<IntclrSpec> {
        FovflW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO Underflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fundfl(&mut self) -> FundflW<IntclrSpec> {
        FundflW::new(self, 2)
    }
    #[doc = "Bit 3 - FIFO Read Error interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn frderr(&mut self) -> FrderrW<IntclrSpec> {
        FrderrW::new(self, 3)
    }
    #[doc = "Bit 4 - I2C General Address interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn genad(&mut self) -> GenadW<IntclrSpec> {
        GenadW::new(self, 4)
    }
    #[doc = "Bit 5 - IO Write interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn iointw(&mut self) -> IointwW<IntclrSpec> {
        IointwW::new(self, 5)
    }
    #[doc = "Bit 6 - Transfer complete interrupt, read from FIFO space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmprf(&mut self) -> XcmprfW<IntclrSpec> {
        XcmprfW::new(self, 6)
    }
    #[doc = "Bit 7 - Transfer complete interrupt, read from register space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmprr(&mut self) -> XcmprrW<IntclrSpec> {
        XcmprrW::new(self, 7)
    }
    #[doc = "Bit 8 - Transfer complete interrupt, write to FIFO space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmpwf(&mut self) -> XcmpwfW<IntclrSpec> {
        XcmpwfW::new(self, 8)
    }
    #[doc = "Bit 9 - Transfer complete interrupt, write to register space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmpwr(&mut self) -> XcmpwrW<IntclrSpec> {
        XcmpwrW::new(self, 9)
    }
}
