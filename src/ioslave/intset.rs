...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsize(&mut self) -> FsizeW<IntsetSpec> {
        FsizeW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Overflow interrupt."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn frderr(&mut self) -> FrderrW<IntsetSpec> {
        FrderrW::new(self, 3)
    }
    #[doc = "Bit 4 - I2C General Address interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn genad(&mut self) -> GenadW<IntsetSpec> {
        GenadW::new(self, 4)
    }
    #[doc = "Bit 5 - IO Write interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn iointw(&mut self) -> IointwW<IntsetSpec> {
        IointwW::new(self, 5)
    }
    #[doc = "Bit 6 - Transfer complete interrupt, read from FIFO space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmprf(&mut self) -> XcmprfW<IntsetSpec> {
        XcmprfW::new(self, 6)
    }
    #[doc = "Bit 7 - Transfer complete interrupt, read from register space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmprr(&mut self) -> XcmprrW<IntsetSpec> {
        XcmprrW::new(self, 7)
    }
    #[doc = "Bit 8 - Transfer complete interrupt, write to FIFO space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmpwf(&mut self) -> XcmpwfW<IntsetSpec> {
        XcmpwfW::new(self, 8)
    }
    #[doc = "Bit 9 - Transfer complete interrupt, write to register space."]
    #[inline(always)]
    #[must_use]
    pub fn xcmpwr(&mut self) -> XcmpwrW<IntsetSpec> {
        XcmpwrW::new(self, 9)
    }
}
