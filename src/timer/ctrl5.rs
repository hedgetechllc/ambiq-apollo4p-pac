...
pub type R = crate::R<Ctrl5Spec>;
#[doc = "Register `CTRL5` writer"]
pub type W = crate::W<Ctrl5Spec>;
#[doc = "Counter/Timer 5 Enable bit.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Tmr5en {
    #[doc = "0: Counter/Timer 5 Disable."]
    Dis = 0,
    #[doc = "1: Counter/Timer 5 Enable."]
    En = 1,
}
impl From<Tmr5en> for bool {
    #[inline(always)]
    fn from(variant: Tmr5en) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TMR5EN` reader - Counter/Timer 5 Enable bit."]
pub type Tmr5enR = crate::BitReader<Tmr5en>;
impl Tmr5enR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tmr5en {
        match self.bits {
            false => Tmr5en::Dis,
            true => Tmr5en::En,
        }
    }
    #[doc = "Counter/Timer 5 Disable."]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == Tmr5en::Dis
    }
    #[doc = "Counter/Timer 5 Enable."]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == Tmr5en::En
    }
}
#[doc = "Field `TMR5EN` writer - Counter/Timer 5 Enable bit."]
pub type Tmr5enW<'a, REG> = crate::BitWriter<'a, REG, Tmr5en>;
impl<'a, REG> Tmr5enW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn dis(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5en::Dis)
    }
    #[doc = "Counter/Timer 5 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5en::En)
    }
}
...
impl From<Tmr5clr> for bool {
    #[inline(always)]
    fn from(variant: Tmr5clr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TMR5CLR` reader - Counter/Timer Clear bit."]
pub type Tmr5clrR = crate::BitReader<Tmr5clr>;
impl Tmr5clrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tmr5clr {
        match self.bits {
            true => Tmr5clr::Clear,
            false => Tmr5clr::Default,
        }
    }
    ...
    pub fn is_default(&self) -> bool {
        *self == Tmr5clr::Default
    }
}
#[doc = "Field `TMR5CLR` writer - Counter/Timer Clear bit."]
pub type Tmr5clrW<'a, REG> = crate::BitWriter<'a, REG, Tmr5clr>;
impl<'a, REG> Tmr5clrW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "When written to a 1, the timer will automatically be cleared to its reset state # (0 for count up counter, CMP0 for down counter)"]
    ...
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5clr::Clear)
    }
    #[doc = "Default value set to 0. Timer works normally."]
    #[inline(always)]
    pub fn default(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5clr::Default)
    }
}
#[doc = "Counter/Timer 5 output 0 polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Tmr5pol0 {
    #[doc = "0: The polarity of the TMR5OUT0 pin is the same as the timer output."]
    Normal = 0,
    #[doc = "1: The polarity of the TMR5OUT0 pin is the inverse of the timer output."]
    Inverted = 1,
}
impl From<Tmr5pol0> for bool {
    #[inline(always)]
    fn from(variant: Tmr5pol0) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TMR5POL0` reader - Counter/Timer 5 output 0 polarity."]
pub type Tmr5pol0R = crate::BitReader<Tmr5pol0>;
impl Tmr5pol0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tmr5pol0 {
        match self.bits {
            false => Tmr5pol0::Normal,
            true => Tmr5pol0::Inverted,
        }
    }
    #[doc = "The polarity of the TMR5OUT0 pin is the same as the timer output."]
    #[inline(always)]
    pub fn is_normal(&self) -> bool {
        *self == Tmr5pol0::Normal
    }
    #[doc = "The polarity of the TMR5OUT0 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn is_inverted(&self) -> bool {
        *self == Tmr5pol0::Inverted
    }
}
#[doc = "Field `TMR5POL0` writer - Counter/Timer 5 output 0 polarity."]
pub type Tmr5pol0W<'a, REG> = crate::BitWriter<'a, REG, Tmr5pol0>;
impl<'a, REG> Tmr5pol0W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The polarity of the TMR5OUT0 pin is the same as the timer output."]
    ...
    pub fn normal(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5pol0::Normal)
    }
    #[doc = "The polarity of the TMR5OUT0 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5pol0::Inverted)
    }
}
#[doc = "Counter/Timer 5 output 1 polarity.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Tmr5pol1 {
    #[doc = "0: The polarity of the TMR5OUT1 pin is the same as the timer output."]
    Normal = 0,
    #[doc = "1: The polarity of the TMR5OUT1 pin is the inverse of the timer output."]
    Inverted = 1,
}
impl From<Tmr5pol1> for bool {
    #[inline(always)]
    fn from(variant: Tmr5pol1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TMR5POL1` reader - Counter/Timer 5 output 1 polarity."]
pub type Tmr5pol1R = crate::BitReader<Tmr5pol1>;
impl Tmr5pol1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tmr5pol1 {
        match self.bits {
            false => Tmr5pol1::Normal,
            true => Tmr5pol1::Inverted,
        }
    }
    #[doc = "The polarity of the TMR5OUT1 pin is the same as the timer output."]
    #[inline(always)]
    pub fn is_normal(&self) -> bool {
        *self == Tmr5pol1::Normal
    }
    #[doc = "The polarity of the TMR5OUT1 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn is_inverted(&self) -> bool {
        *self == Tmr5pol1::Inverted
    }
}
#[doc = "Field `TMR5POL1` writer - Counter/Timer 5 output 1 polarity."]
pub type Tmr5pol1W<'a, REG> = crate::BitWriter<'a, REG, Tmr5pol1>;
impl<'a, REG> Tmr5pol1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The polarity of the TMR5OUT1 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5pol1::Normal)
    }
    #[doc = "The polarity of the TMR5OUT1 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5pol1::Inverted)
    }
}
#[doc = "Counter/Timer 5 Function Select. For all Functions, CMP0 marks the end of timer cycle, and thus restarts the timer.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr5fn {
...
impl From<Tmr5fn> for u8 {
    #[inline(always)]
    fn from(variant: Tmr5fn) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr5fn {
    type Ux = u8;
}
impl crate::IsEnum for Tmr5fn {}
#[doc = "Field `TMR5FN` reader - Counter/Timer 5 Function Select. For all Functions, CMP0 marks the end of timer cycle, and thus restarts the timer."]
pub type Tmr5fnR = crate::FieldReader<Tmr5fn>;
impl Tmr5fnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr5fn> {
        match self.bits {
            1 => Some(Tmr5fn::Edge),
            2 => Some(Tmr5fn::Upcount),
            4 => Some(Tmr5fn::Pwm),
            12 => Some(Tmr5fn::Singlepattern),
            13 => Some(Tmr5fn::Repeatpattern),
            _ => None,
        }
    }
...
is pulsed for one source clock period when TIMER matches CMP0/CMP1 respectively. Timer repeats for TMR_LMT iterations."]
    ...
    pub fn is_singlepattern(&self) -> bool {
        *self == Tmr5fn::Singlepattern
    }
    #[doc = "Repeated pattern. Like SINGLEPATTERN mode, but pattern repeats after reaching LMT."]
    #[inline(always)]
    pub fn is_repeatpattern(&self) -> bool {
        *self == Tmr5fn::Repeatpattern
    }
}
#[doc = "Field `TMR5FN` writer - Counter/Timer 5 Function Select. For all Functions, CMP0 marks the end of timer cycle, and thus restarts the timer."]
pub type Tmr5fnW<'a, REG> = crate::FieldWriter<'a, REG, 4, Tmr5fn>;
impl<'a, REG> Tmr5fnW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
follows CMP1."]
    ...
    pub fn edge(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5fn::Edge)
    }
    #[doc = "This mode is run up counter generating a pulse on CMP. OUT\\[0\\]/OUT\\[1\\]
is pulsed for one source clock period when TIMER matches CMP0/CMP1 respectively. Timer repeats for TMR_LMT iterations."]
    #[inline(always)]
    pub fn upcount(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5fn::Upcount)
    }
    #[doc = "PWM mode. OUT0 and OUT1 are waveforms, and not just one clock pulse. CMP1 dictates the low phase of the output and CMP0 dictates the period. OUT\\[1\\]=~OUT\\[0\\]."]
    #[inline(always)]
    pub fn pwm(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5fn::Pwm)
    }
    #[doc = "Single pattern. OUT0=CMP0\\[TIMER\\], OUT1=CMP1\\[TIMER\\]. LMT field specifies length of pattern. When LMT GT 32 OUT0 and OUT1 is the same 64-bit pattern consisting of concatenated CMP1,CMP0. When LMT LT 32 OUT0 and OUT1 are independent. Both OUT0 and OUT1 can be inverted individually applications with POL0/POL1 = 0x1."]
    #[inline(always)]
    pub fn singlepattern(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5fn::Singlepattern)
    }
    #[doc = "Repeated pattern. Like SINGLEPATTERN mode, but pattern repeats after reaching LMT."]
    #[inline(always)]
    pub fn repeatpattern(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5fn::Repeatpattern)
    }
}
#[doc = "Counter/Timer 5 Clock Select.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr5clk {
...
impl From<Tmr5clk> for u8 {
    #[inline(always)]
    fn from(variant: Tmr5clk) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr5clk {
    type Ux = u8;
}
impl crate::IsEnum for Tmr5clk {}
#[doc = "Field `TMR5CLK` reader - Counter/Timer 5 Clock Select."]
pub type Tmr5clkR = crate::FieldReader<Tmr5clk>;
impl Tmr5clkR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr5clk> {
        match self.bits {
            0 => Some(Tmr5clk::HfrcDiv4),
            1 => Some(Tmr5clk::HfrcDiv16),
            2 => Some(Tmr5clk::HfrcDiv64),
            3 => Some(Tmr5clk::HfrcDiv256),
            4 => Some(Tmr5clk::HfrcDiv1024),
            5 => Some(Tmr5clk::HfrcDiv4k),
            6 => Some(Tmr5clk::Lfrc),
            7 => Some(Tmr5clk::LfrcDiv2),
            8 => Some(Tmr5clk::LfrcDiv32),
            9 => Some(Tmr5clk::LfrcDiv1k),
            10 => Some(Tmr5clk::Xt),
            11 => Some(Tmr5clk::XtDiv2),
            12 => Some(Tmr5clk::XtDiv4),
            13 => Some(Tmr5clk::XtDiv8),
            14 => Some(Tmr5clk::XtDiv16),
            15 => Some(Tmr5clk::XtDiv32),
            16 => Some(Tmr5clk::XtDiv128),
            17 => Some(Tmr5clk::Rtc100hz),
            28 => Some(Tmr5clk::Buckc),
            29 => Some(Tmr5clk::Buckf),
            30 => Some(Tmr5clk::Bucks),
            31 => Some(Tmr5clk::BuckcLv),
            32 => Some(Tmr5clk::Tmr00),
            33 => Some(Tmr5clk::Tmr01),
            34 => Some(Tmr5clk::Tmr10),
            35 => Some(Tmr5clk::Tmr11),
            36 => Some(Tmr5clk::Tmr20),
            37 => Some(Tmr5clk::Tmr21),
            38 => Some(Tmr5clk::Tmr30),
            39 => Some(Tmr5clk::Tmr31),
            40 => Some(Tmr5clk::Tmr40),
            41 => Some(Tmr5clk::Tmr41),
            42 => Some(Tmr5clk::Tmr50),
            43 => Some(Tmr5clk::Tmr51),
            44 => Some(Tmr5clk::Tmr60),
            45 => Some(Tmr5clk::Tmr61),
            46 => Some(Tmr5clk::Tmr70),
            47 => Some(Tmr5clk::Tmr71),
            48 => Some(Tmr5clk::Tmr80),
            49 => Some(Tmr5clk::Tmr81),
            50 => Some(Tmr5clk::Tmr90),
            51 => Some(Tmr5clk::Tmr91),
            52 => Some(Tmr5clk::Tmr100),
            53 => Some(Tmr5clk::Tmr101),
            54 => Some(Tmr5clk::Tmr110),
            55 => Some(Tmr5clk::Tmr111),
            56 => Some(Tmr5clk::Tmr120),
            57 => Some(Tmr5clk::Tmr121),
            58 => Some(Tmr5clk::Tmr130),
            59 => Some(Tmr5clk::Tmr131),
            60 => Some(Tmr5clk::Tmr140),
            61 => Some(Tmr5clk::Tmr141),
            62 => Some(Tmr5clk::Tmr150),
            63 => Some(Tmr5clk::Tmr151),
            128 => Some(Tmr5clk::Gpio0),
            191 => Some(Tmr5clk::Gpio63),
            223 => Some(Tmr5clk::Gpio95),
            255 => Some(Tmr5clk::Gpio127),
            _ => None,
        }
    }
    ...
    pub fn is_gpio127(&self) -> bool {
        *self == Tmr5clk::Gpio127
    }
}
#[doc = "Field `TMR5CLK` writer - Counter/Timer 5 Clock Select."]
pub type Tmr5clkW<'a, REG> = crate::FieldWriter<'a, REG, 8, Tmr5clk>;
impl<'a, REG> Tmr5clkW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl From<Tmr5tmode> for u8 {
    #[inline(always)]
    fn from(variant: Tmr5tmode) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr5tmode {
    type Ux = u8;
}
impl crate::IsEnum for Tmr5tmode {}
#[doc = "Field `TMR5TMODE` reader - Counter/Timer 5 Trigger Mode"]
pub type Tmr5tmodeR = crate::FieldReader<Tmr5tmode>;
impl Tmr5tmodeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Tmr5tmode {
        match self.bits {
            0 => Tmr5tmode::Dis,
            1 => Tmr5tmode::Rise,
            2 => Tmr5tmode::Fall,
...
#[doc = "Field `TMR5TMODE` writer - Counter/Timer 5 Trigger Mode"]
pub type Tmr5tmodeW<'a, REG> = crate::FieldWriter<'a, REG, 2, Tmr5tmode, crate::Safe>;
impl<'a, REG> Tmr5tmodeW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn dis(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5tmode::Dis)
    }
    #[doc = "Trigger on rising edge of TRIGSEL source"]
    #[inline(always)]
    pub fn rise(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5tmode::Rise)
    }
    #[doc = "Trigger on falling edge of TRIGSEL source"]
    #[inline(always)]
    pub fn fall(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5tmode::Fall)
    }
    #[doc = "Trigger on either edge of TRIGSEL source"]
    #[inline(always)]
    pub fn both(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr5tmode::Both)
    }
}
#[doc = "Field `TMR5LMT` reader - This field decides the number of iterations of Counter/Timer 5. For Single/Repeat Patterns, it indicates number of bits to be shifted out and so, max value is 63."]
pub type Tmr5lmtR = crate::FieldReader;
#[doc = "Field `TMR5LMT` writer - This field decides the number of iterations of Counter/Timer 5. For Single/Repeat Patterns, it indicates number of bits to be shifted out and so, max value is 63."]
pub type Tmr5lmtW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - Counter/Timer 5 Enable bit."]
    #[inline(always)]
    pub fn tmr5en(&self) -> Tmr5enR {
        Tmr5enR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Counter/Timer Clear bit."]
    #[inline(always)]
    pub fn tmr5clr(&self) -> Tmr5clrR {
        Tmr5clrR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Counter/Timer 5 output 0 polarity."]
    #[inline(always)]
    pub fn tmr5pol0(&self) -> Tmr5pol0R {
        Tmr5pol0R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Counter/Timer 5 output 1 polarity."]
    #[inline(always)]
    pub fn tmr5pol1(&self) -> Tmr5pol1R {
        Tmr5pol1R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:7 - Counter/Timer 5 Function Select. For all Functions, CMP0 marks the end of timer cycle, and thus restarts the timer."]
    #[inline(always)]
    pub fn tmr5fn(&self) -> Tmr5fnR {
        Tmr5fnR::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bits 8:15 - Counter/Timer 5 Clock Select."]
    #[inline(always)]
    pub fn tmr5clk(&self) -> Tmr5clkR {
        Tmr5clkR::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:17 - Counter/Timer 5 Trigger Mode"]
    #[inline(always)]
    pub fn tmr5tmode(&self) -> Tmr5tmodeR {
        Tmr5tmodeR::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 24:31 - This field decides the number of iterations of Counter/Timer 5. For Single/Repeat Patterns, it indicates number of bits to be shifted out and so, max value is 63."]
    #[inline(always)]
    pub fn tmr5lmt(&self) -> Tmr5lmtR {
        Tmr5lmtR::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Counter/Timer 5 Enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5en(&mut self) -> Tmr5enW<Ctrl5Spec> {
        Tmr5enW::new(self, 0)
    }
    #[doc = "Bit 1 - Counter/Timer Clear bit."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5clr(&mut self) -> Tmr5clrW<Ctrl5Spec> {
        Tmr5clrW::new(self, 1)
    }
    #[doc = "Bit 2 - Counter/Timer 5 output 0 polarity."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5pol0(&mut self) -> Tmr5pol0W<Ctrl5Spec> {
        Tmr5pol0W::new(self, 2)
    }
    #[doc = "Bit 3 - Counter/Timer 5 output 1 polarity."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5pol1(&mut self) -> Tmr5pol1W<Ctrl5Spec> {
        Tmr5pol1W::new(self, 3)
    }
    #[doc = "Bits 4:7 - Counter/Timer 5 Function Select. For all Functions, CMP0 marks the end of timer cycle, and thus restarts the timer."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5fn(&mut self) -> Tmr5fnW<Ctrl5Spec> {
        Tmr5fnW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Counter/Timer 5 Clock Select."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5clk(&mut self) -> Tmr5clkW<Ctrl5Spec> {
        Tmr5clkW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Counter/Timer 5 Trigger Mode"]
    #[inline(always)]
    #[must_use]
    pub fn tmr5tmode(&mut self) -> Tmr5tmodeW<Ctrl5Spec> {
        Tmr5tmodeW::new(self, 16)
    }
    #[doc = "Bits 24:31 - This field decides the number of iterations of Counter/Timer 5. For Single/Repeat Patterns, it indicates number of bits to be shifted out and so, max value is 63."]
    #[inline(always)]
    #[must_use]
    pub fn tmr5lmt(&mut self) -> Tmr5lmtW<Ctrl5Spec> {
        Tmr5lmtW::new(self, 24)
    }
}
#[doc = "This includes the Control bit fields for timer 5.\n\nYou can [`read`](crate::Reg::read) this register and get [`ctrl5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctrl5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctrl5Spec;
impl crate::RegisterSpec for Ctrl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctrl5::R`](R) reader structure"]
impl crate::Readable for Ctrl5Spec {}
#[doc = "`write(|w| ..)` method takes [`ctrl5::W`](W) writer structure"]
impl crate::Writable for Ctrl5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTRL5 to value 0"]
impl crate::Resettable for Ctrl5Spec {
