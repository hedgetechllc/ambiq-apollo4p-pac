...
#[doc = "Counter/Timer 5 Trigger Source Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr5trigsel {
...
impl From<Tmr5trigsel> for u8 {
    #[inline(always)]
    fn from(variant: Tmr5trigsel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr5trigsel {
    type Ux = u8;
}
impl crate::IsEnum for Tmr5trigsel {}
#[doc = "Field `TMR5TRIGSEL` reader - Counter/Timer 5 Trigger Source Selection"]
pub type Tmr5trigselR = crate::FieldReader<Tmr5trigsel>;
impl Tmr5trigselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr5trigsel> {
        match self.bits {
            0 => Some(Tmr5trigsel::Tmr00),
            1 => Some(Tmr5trigsel::Tmr01),
            2 => Some(Tmr5trigsel::Tmr10),
            3 => Some(Tmr5trigsel::Tmr11),
            4 => Some(Tmr5trigsel::Tmr20),
            5 => Some(Tmr5trigsel::Tmr21),
            6 => Some(Tmr5trigsel::Tmr30),
            7 => Some(Tmr5trigsel::Tmr31),
            8 => Some(Tmr5trigsel::Tmr40),
            9 => Some(Tmr5trigsel::Tmr41),
            10 => Some(Tmr5trigsel::Tmr50),
            11 => Some(Tmr5trigsel::Tmr51),
            12 => Some(Tmr5trigsel::Tmr60),
            13 => Some(Tmr5trigsel::Tmr61),
            14 => Some(Tmr5trigsel::Tmr70),
            15 => Some(Tmr5trigsel::Tmr71),
            16 => Some(Tmr5trigsel::Tmr80),
            17 => Some(Tmr5trigsel::Tmr81),
            18 => Some(Tmr5trigsel::Tmr90),
            19 => Some(Tmr5trigsel::Tmr91),
            20 => Some(Tmr5trigsel::Tmr100),
            21 => Some(Tmr5trigsel::Tmr101),
            22 => Some(Tmr5trigsel::Tmr110),
            23 => Some(Tmr5trigsel::Tmr111),
            24 => Some(Tmr5trigsel::Tmr120),
            25 => Some(Tmr5trigsel::Tmr121),
            26 => Some(Tmr5trigsel::Tmr130),
            27 => Some(Tmr5trigsel::Tmr131),
            28 => Some(Tmr5trigsel::Tmr140),
            29 => Some(Tmr5trigsel::Tmr141),
            30 => Some(Tmr5trigsel::Tmr150),
            31 => Some(Tmr5trigsel::Tmr151),
            128 => Some(Tmr5trigsel::Gpio0),
            255 => Some(Tmr5trigsel::Gpio127),
            _ => None,
        }
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr5trigsel(&mut self) -> Tmr5trigselW<Mode5Spec> {
        Tmr5trigselW::new(self, 8)
    }
}
...
#[doc = "`reset()` method sets MODE5 to value 0"]
