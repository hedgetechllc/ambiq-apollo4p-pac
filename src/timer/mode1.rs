...
#[doc = "Counter/Timer 1 Trigger Source Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr1trigsel {
...
impl From<Tmr1trigsel> for u8 {
    #[inline(always)]
    fn from(variant: Tmr1trigsel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr1trigsel {
    type Ux = u8;
}
impl crate::IsEnum for Tmr1trigsel {}
#[doc = "Field `TMR1TRIGSEL` reader - Counter/Timer 1 Trigger Source Selection"]
pub type Tmr1trigselR = crate::FieldReader<Tmr1trigsel>;
impl Tmr1trigselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr1trigsel> {
        match self.bits {
            0 => Some(Tmr1trigsel::Tmr00),
            1 => Some(Tmr1trigsel::Tmr01),
            2 => Some(Tmr1trigsel::Tmr10),
            3 => Some(Tmr1trigsel::Tmr11),
            4 => Some(Tmr1trigsel::Tmr20),
            5 => Some(Tmr1trigsel::Tmr21),
            6 => Some(Tmr1trigsel::Tmr30),
            7 => Some(Tmr1trigsel::Tmr31),
            8 => Some(Tmr1trigsel::Tmr40),
            9 => Some(Tmr1trigsel::Tmr41),
            10 => Some(Tmr1trigsel::Tmr50),
            11 => Some(Tmr1trigsel::Tmr51),
            12 => Some(Tmr1trigsel::Tmr60),
            13 => Some(Tmr1trigsel::Tmr61),
            14 => Some(Tmr1trigsel::Tmr70),
            15 => Some(Tmr1trigsel::Tmr71),
            16 => Some(Tmr1trigsel::Tmr80),
            17 => Some(Tmr1trigsel::Tmr81),
            18 => Some(Tmr1trigsel::Tmr90),
            19 => Some(Tmr1trigsel::Tmr91),
            20 => Some(Tmr1trigsel::Tmr100),
            21 => Some(Tmr1trigsel::Tmr101),
            22 => Some(Tmr1trigsel::Tmr110),
            23 => Some(Tmr1trigsel::Tmr111),
            24 => Some(Tmr1trigsel::Tmr120),
            25 => Some(Tmr1trigsel::Tmr121),
            26 => Some(Tmr1trigsel::Tmr130),
            27 => Some(Tmr1trigsel::Tmr131),
            28 => Some(Tmr1trigsel::Tmr140),
            29 => Some(Tmr1trigsel::Tmr141),
            30 => Some(Tmr1trigsel::Tmr150),
            31 => Some(Tmr1trigsel::Tmr151),
            128 => Some(Tmr1trigsel::Gpio0),
            255 => Some(Tmr1trigsel::Gpio127),
            _ => None,
        }
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr1trigsel(&mut self) -> Tmr1trigselW<Mode1Spec> {
        Tmr1trigselW::new(self, 8)
    }
}
...
#[doc = "`reset()` method sets MODE1 to value 0"]
