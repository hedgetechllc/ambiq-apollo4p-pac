...
#[doc = "Counter/Timer 0 Trigger Source Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr0trigsel {
...
impl From<Tmr0trigsel> for u8 {
    #[inline(always)]
    fn from(variant: Tmr0trigsel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr0trigsel {
    type Ux = u8;
}
impl crate::IsEnum for Tmr0trigsel {}
#[doc = "Field `TMR0TRIGSEL` reader - Counter/Timer 0 Trigger Source Selection"]
pub type Tmr0trigselR = crate::FieldReader<Tmr0trigsel>;
impl Tmr0trigselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr0trigsel> {
        match self.bits {
            0 => Some(Tmr0trigsel::Tmr00),
            1 => Some(Tmr0trigsel::Tmr01),
            2 => Some(Tmr0trigsel::Tmr10),
            3 => Some(Tmr0trigsel::Tmr11),
            4 => Some(Tmr0trigsel::Tmr20),
            5 => Some(Tmr0trigsel::Tmr21),
            6 => Some(Tmr0trigsel::Tmr30),
            7 => Some(Tmr0trigsel::Tmr31),
            8 => Some(Tmr0trigsel::Tmr40),
            9 => Some(Tmr0trigsel::Tmr41),
            10 => Some(Tmr0trigsel::Tmr50),
            11 => Some(Tmr0trigsel::Tmr51),
            12 => Some(Tmr0trigsel::Tmr60),
            13 => Some(Tmr0trigsel::Tmr61),
            14 => Some(Tmr0trigsel::Tmr70),
            15 => Some(Tmr0trigsel::Tmr71),
            16 => Some(Tmr0trigsel::Tmr80),
            17 => Some(Tmr0trigsel::Tmr81),
            18 => Some(Tmr0trigsel::Tmr90),
            19 => Some(Tmr0trigsel::Tmr91),
            20 => Some(Tmr0trigsel::Tmr100),
            21 => Some(Tmr0trigsel::Tmr101),
            22 => Some(Tmr0trigsel::Tmr110),
            23 => Some(Tmr0trigsel::Tmr111),
            24 => Some(Tmr0trigsel::Tmr120),
            25 => Some(Tmr0trigsel::Tmr121),
            26 => Some(Tmr0trigsel::Tmr130),
            27 => Some(Tmr0trigsel::Tmr131),
            28 => Some(Tmr0trigsel::Tmr140),
            29 => Some(Tmr0trigsel::Tmr141),
            30 => Some(Tmr0trigsel::Tmr150),
            31 => Some(Tmr0trigsel::Tmr151),
            128 => Some(Tmr0trigsel::Gpio0),
            255 => Some(Tmr0trigsel::Gpio127),
            _ => None,
        }
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr0trigsel(&mut self) -> Tmr0trigselW<Mode0Spec> {
        Tmr0trigselW::new(self, 8)
    }
}
