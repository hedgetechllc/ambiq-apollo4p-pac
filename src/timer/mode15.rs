#[doc = "Register `MODE15` reader"]
pub type R = crate::R<Mode15Spec>;
#[doc = "Register `MODE15` writer"]
pub type W = crate::W<Mode15Spec>;
#[doc = "Counter/Timer 15 Trigger Source Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr15trigsel {
...
impl From<Tmr15trigsel> for u8 {
    #[inline(always)]
    fn from(variant: Tmr15trigsel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr15trigsel {
    type Ux = u8;
}
impl crate::IsEnum for Tmr15trigsel {}
#[doc = "Field `TMR15TRIGSEL` reader - Counter/Timer 15 Trigger Source Selection"]
pub type Tmr15trigselR = crate::FieldReader<Tmr15trigsel>;
impl Tmr15trigselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr15trigsel> {
        match self.bits {
            0 => Some(Tmr15trigsel::Tmr00),
            1 => Some(Tmr15trigsel::Tmr01),
            2 => Some(Tmr15trigsel::Tmr10),
            3 => Some(Tmr15trigsel::Tmr11),
            4 => Some(Tmr15trigsel::Tmr20),
            5 => Some(Tmr15trigsel::Tmr21),
            6 => Some(Tmr15trigsel::Tmr30),
            7 => Some(Tmr15trigsel::Tmr31),
            8 => Some(Tmr15trigsel::Tmr40),
            9 => Some(Tmr15trigsel::Tmr41),
            10 => Some(Tmr15trigsel::Tmr50),
            11 => Some(Tmr15trigsel::Tmr51),
            12 => Some(Tmr15trigsel::Tmr60),
            13 => Some(Tmr15trigsel::Tmr61),
            14 => Some(Tmr15trigsel::Tmr70),
            15 => Some(Tmr15trigsel::Tmr71),
            16 => Some(Tmr15trigsel::Tmr80),
            17 => Some(Tmr15trigsel::Tmr81),
            18 => Some(Tmr15trigsel::Tmr90),
            19 => Some(Tmr15trigsel::Tmr91),
            20 => Some(Tmr15trigsel::Tmr100),
            21 => Some(Tmr15trigsel::Tmr101),
            22 => Some(Tmr15trigsel::Tmr110),
            23 => Some(Tmr15trigsel::Tmr111),
            24 => Some(Tmr15trigsel::Tmr120),
            25 => Some(Tmr15trigsel::Tmr121),
            26 => Some(Tmr15trigsel::Tmr130),
            27 => Some(Tmr15trigsel::Tmr131),
            28 => Some(Tmr15trigsel::Tmr140),
            29 => Some(Tmr15trigsel::Tmr141),
            30 => Some(Tmr15trigsel::Tmr150),
            31 => Some(Tmr15trigsel::Tmr151),
            128 => Some(Tmr15trigsel::Gpio0),
            255 => Some(Tmr15trigsel::Gpio127),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tmr00(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr00)
    }
    #[doc = "Trigger source is TIMER 0 Output 1"]
    #[inline(always)]
    pub fn tmr01(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr01)
    }
    #[doc = "Trigger source is TIMER 1 Output 0"]
    #[inline(always)]
    pub fn tmr10(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr10)
    }
    #[doc = "Trigger source is TIMER 1 Output 1"]
    #[inline(always)]
    pub fn tmr11(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr11)
    }
    #[doc = "Trigger source is TIMER 2 Output 0"]
    #[inline(always)]
    pub fn tmr20(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr20)
    }
    #[doc = "Trigger source is TIMER 2 Output 1"]
    #[inline(always)]
    pub fn tmr21(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr21)
    }
    #[doc = "Trigger source is TIMER 3 Output 0"]
    #[inline(always)]
    pub fn tmr30(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr30)
    }
    #[doc = "Trigger source is TIMER 3 Output 1"]
    #[inline(always)]
    pub fn tmr31(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr31)
    }
    #[doc = "Trigger source is TIMER 4 Output 0"]
    #[inline(always)]
    pub fn tmr40(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr40)
    }
    #[doc = "Trigger source is TIMER 4 Output 1"]
    #[inline(always)]
    pub fn tmr41(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr41)
    }
    #[doc = "Trigger source is TIMER 5 Output 0"]
    #[inline(always)]
    pub fn tmr50(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr50)
    }
    #[doc = "Trigger source is TIMER 5 Output 1"]
    #[inline(always)]
    pub fn tmr51(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr51)
    }
    #[doc = "Trigger source is TIMER 6 Output 0"]
    #[inline(always)]
    pub fn tmr60(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr60)
    }
    #[doc = "Trigger source is TIMER 6 Output 1"]
    #[inline(always)]
    pub fn tmr61(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr61)
    }
    #[doc = "Trigger source is TIMER 7 Output 0"]
    #[inline(always)]
    pub fn tmr70(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr70)
    }
    #[doc = "Trigger source is TIMER 7 Output 1"]
    #[inline(always)]
    pub fn tmr71(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr71)
    }
    #[doc = "Trigger source is TIMER 8 Output 0"]
    #[inline(always)]
    pub fn tmr80(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr80)
    }
    #[doc = "Trigger source is TIMER 8 Output 1"]
    #[inline(always)]
    pub fn tmr81(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr81)
    }
    #[doc = "Trigger source is TIMER 9 Output 0"]
    #[inline(always)]
    pub fn tmr90(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr90)
    }
    #[doc = "Trigger source is TIMER 9 Output 1"]
    #[inline(always)]
    pub fn tmr91(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr91)
    }
    #[doc = "Trigger source is TIMER 10 Output 0"]
    #[inline(always)]
    pub fn tmr100(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr100)
    }
    #[doc = "Trigger source is TIMER 10 Output 1"]
    #[inline(always)]
    pub fn tmr101(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr101)
    }
    #[doc = "Trigger source is TIMER 11 Output 0"]
    #[inline(always)]
    pub fn tmr110(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr110)
    }
    #[doc = "Trigger source is TIMER 11 Output 1"]
    #[inline(always)]
    pub fn tmr111(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr111)
    }
    #[doc = "Trigger source is TIMER 12 Output 0"]
    #[inline(always)]
    pub fn tmr120(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr120)
    }
    #[doc = "Trigger source is TIMER 12 Output 1"]
    #[inline(always)]
    pub fn tmr121(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr121)
    }
    #[doc = "Trigger source is TIMER 13 Output 0"]
    #[inline(always)]
    pub fn tmr130(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr130)
    }
    #[doc = "Trigger source is TIMER 13 Output 1"]
    #[inline(always)]
    pub fn tmr131(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr131)
    }
    #[doc = "Trigger source is TIMER 14 Output 0"]
    #[inline(always)]
    pub fn tmr140(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr140)
    }
    #[doc = "Trigger source is TIMER 14 Output 1"]
    #[inline(always)]
    pub fn tmr141(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr141)
    }
    #[doc = "Trigger source is TIMER 15 Output 0"]
    #[inline(always)]
    pub fn tmr150(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr150)
    }
    #[doc = "Trigger source is TIMER 15 Output 1"]
    #[inline(always)]
    pub fn tmr151(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Tmr151)
    }
    #[doc = "Trigger source is GPIO #0"]
    #[inline(always)]
    pub fn gpio0(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Gpio0)
    }
    #[doc = "Trigger source is GPIO #127"]
    #[inline(always)]
    pub fn gpio127(self) -> &'a mut crate::W<REG> {
        self.variant(Tmr15trigsel::Gpio127)
    }
}
impl R {
    #[doc = "Bits 8:15 - Counter/Timer 15 Trigger Source Selection"]
    #[inline(always)]
    pub fn tmr15trigsel(&self) -> Tmr15trigselR {
        Tmr15trigselR::new(((self.bits >> 8) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 8:15 - Counter/Timer 15 Trigger Source Selection"]
    #[inline(always)]
    #[must_use]
    pub fn tmr15trigsel(&mut self) -> Tmr15trigselW<Mode15Spec> {
        Tmr15trigselW::new(self, 8)
    }
}
#[doc = "The mode register contains optional mode controls for the timer\n\nYou can [`read`](crate::Reg::read) this register and get [`mode15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mode15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mode15Spec;
impl crate::RegisterSpec for Mode15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mode15::R`](R) reader structure"]
impl crate::Readable for Mode15Spec {}
#[doc = "`write(|w| ..)` method takes [`mode15::W`](W) writer structure"]
impl crate::Writable for Mode15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MODE15 to value 0"]
impl crate::Resettable for Mode15Spec {
