...
#[doc = "Counter/Timer 4 Trigger Source Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Tmr4trigsel {
...
impl From<Tmr4trigsel> for u8 {
    #[inline(always)]
    fn from(variant: Tmr4trigsel) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Tmr4trigsel {
    type Ux = u8;
}
impl crate::IsEnum for Tmr4trigsel {}
#[doc = "Field `TMR4TRIGSEL` reader - Counter/Timer 4 Trigger Source Selection"]
pub type Tmr4trigselR = crate::FieldReader<Tmr4trigsel>;
impl Tmr4trigselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Tmr4trigsel> {
        match self.bits {
            0 => Some(Tmr4trigsel::Tmr00),
            1 => Some(Tmr4trigsel::Tmr01),
            2 => Some(Tmr4trigsel::Tmr10),
            3 => Some(Tmr4trigsel::Tmr11),
            4 => Some(Tmr4trigsel::Tmr20),
            5 => Some(Tmr4trigsel::Tmr21),
            6 => Some(Tmr4trigsel::Tmr30),
            7 => Some(Tmr4trigsel::Tmr31),
            8 => Some(Tmr4trigsel::Tmr40),
            9 => Some(Tmr4trigsel::Tmr41),
            10 => Some(Tmr4trigsel::Tmr50),
            11 => Some(Tmr4trigsel::Tmr51),
            12 => Some(Tmr4trigsel::Tmr60),
            13 => Some(Tmr4trigsel::Tmr61),
            14 => Some(Tmr4trigsel::Tmr70),
            15 => Some(Tmr4trigsel::Tmr71),
            16 => Some(Tmr4trigsel::Tmr80),
            17 => Some(Tmr4trigsel::Tmr81),
            18 => Some(Tmr4trigsel::Tmr90),
            19 => Some(Tmr4trigsel::Tmr91),
            20 => Some(Tmr4trigsel::Tmr100),
            21 => Some(Tmr4trigsel::Tmr101),
            22 => Some(Tmr4trigsel::Tmr110),
            23 => Some(Tmr4trigsel::Tmr111),
            24 => Some(Tmr4trigsel::Tmr120),
            25 => Some(Tmr4trigsel::Tmr121),
            26 => Some(Tmr4trigsel::Tmr130),
            27 => Some(Tmr4trigsel::Tmr131),
            28 => Some(Tmr4trigsel::Tmr140),
            29 => Some(Tmr4trigsel::Tmr141),
            30 => Some(Tmr4trigsel::Tmr150),
            31 => Some(Tmr4trigsel::Tmr151),
            128 => Some(Tmr4trigsel::Gpio0),
            255 => Some(Tmr4trigsel::Gpio127),
            _ => None,
        }
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr4trigsel(&mut self) -> Tmr4trigselW<Mode4Spec> {
        Tmr4trigselW::new(self, 8)
    }
}
...
#[doc = "`reset()` method sets MODE4 to value 0"]
