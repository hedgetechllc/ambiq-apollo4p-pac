...
pub type R = crate::R<StmintclrSpec>;
#[doc = "Register `STMINTCLR` writer"]
pub type W = crate::W<StmintclrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comparea(&mut self) -> CompareaW<StmintclrSpec> {
        CompareaW::new(self, 0)
    }
    #[doc = "Bit 1 - COUNTER is greater than or equal to COMPARE register B."]
    #[inline(always)]
    #[must_use]
    pub fn compareb(&mut self) -> ComparebW<StmintclrSpec> {
        ComparebW::new(self, 1)
    }
    #[doc = "Bit 2 - COUNTER is greater than or equal to COMPARE register C."]
    #[inline(always)]
    #[must_use]
    pub fn comparec(&mut self) -> ComparecW<StmintclrSpec> {
        ComparecW::new(self, 2)
    }
    #[doc = "Bit 3 - COUNTER is greater than or equal to COMPARE register D."]
    #[inline(always)]
    #[must_use]
    pub fn compared(&mut self) -> ComparedW<StmintclrSpec> {
        ComparedW::new(self, 3)
    }
    #[doc = "Bit 4 - COUNTER is greater than or equal to COMPARE register E."]
    #[inline(always)]
    #[must_use]
    pub fn comparee(&mut self) -> CompareeW<StmintclrSpec> {
        CompareeW::new(self, 4)
    }
    #[doc = "Bit 5 - COUNTER is greater than or equal to COMPARE register F."]
    #[inline(always)]
    #[must_use]
    pub fn comparef(&mut self) -> ComparefW<StmintclrSpec> {
        ComparefW::new(self, 5)
    }
    #[doc = "Bit 6 - COUNTER is greater than or equal to COMPARE register G."]
    #[inline(always)]
    #[must_use]
    pub fn compareg(&mut self) -> ComparegW<StmintclrSpec> {
        ComparegW::new(self, 6)
    }
    #[doc = "Bit 7 - COUNTER is greater than or equal to COMPARE register H."]
    #[inline(always)]
    #[must_use]
    pub fn compareh(&mut self) -> ComparehW<StmintclrSpec> {
        ComparehW::new(self, 7)
    }
    #[doc = "Bit 8 - COUNTER over flowed from 0xFFFFFFFF back to 0x00000000."]
    #[inline(always)]
    #[must_use]
    pub fn overflow(&mut self) -> OverflowW<StmintclrSpec> {
        OverflowW::new(self, 8)
    }
    #[doc = "Bit 9 - CAPTURE register A has grabbed the value in the counter"]
    #[inline(always)]
    #[must_use]
    pub fn capturea(&mut self) -> CaptureaW<StmintclrSpec> {
        CaptureaW::new(self, 9)
    }
    #[doc = "Bit 10 - CAPTURE register B has grabbed the value in the counter"]
    #[inline(always)]
    #[must_use]
    pub fn captureb(&mut self) -> CapturebW<StmintclrSpec> {
        CapturebW::new(self, 10)
    }
    #[doc = "Bit 11 - CAPTURE register C has grabbed the value in the counter"]
    #[inline(always)]
    #[must_use]
    pub fn capturec(&mut self) -> CapturecW<StmintclrSpec> {
        CapturecW::new(self, 11)
    }
    #[doc = "Bit 12 - CAPTURE register D has grabbed the value in the counter"]
    #[inline(always)]
    #[must_use]
    pub fn captured(&mut self) -> CapturedW<StmintclrSpec> {
        CapturedW::new(self, 12)
    }
}
#[doc = "Write a 1 to a bit in this register to clear the interrupt status associated with that bit.\n\nYou can [`read`](crate::Reg::read) this register and get [`stmintclr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`stmintclr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct StmintclrSpec;
impl crate::RegisterSpec for StmintclrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`stmintclr::R`](R) reader structure"]
impl crate::Readable for StmintclrSpec {}
#[doc = "`write(|w| ..)` method takes [`stmintclr::W`](W) writer structure"]
impl crate::Writable for StmintclrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets STMINTCLR to value 0"]
impl crate::Resettable for StmintclrSpec {
