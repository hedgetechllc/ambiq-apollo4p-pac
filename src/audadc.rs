...
impl RegisterBlock {
    #[doc = "0x00 - The Audio ADC Configuration Register contains the software control for selecting the clock frequency used for the SAR conversions, the trigger polarity, the trigger select, the reference voltage select, the low power mode, the operating mode (single scan per trigger vs. repeating mode) and AUDADC enable."]
    #[inline(always)]
    pub const fn cfg(&self) -> &Cfg {
        &self.cfg
    }
    #[doc = "0x04 - This register indicates the basic power status for the AUDADC. For detailed power status, see the power control power status register. AUDADC power mode 0 indicates the AUDADC is in its full power state and is ready to process scans. AUDADC Power mode 1 indicates the AUDADC enabled and in a low power state."]
    #[inline(always)]
    pub const fn stat(&self) -> &Stat {
        &self.stat
    }
    #[doc = "0x08 - This register enables initiating an AUDADC scan through software."]
    #[inline(always)]
...
#[doc = "CFG (rw) register accessor: The Audio ADC Configuration Register contains the software control for selecting the clock frequency used for the SAR conversions, the trigger polarity, the trigger select, the reference voltage select, the low power mode, the operating mode (single scan per trigger vs. repeating mode) and AUDADC enable.\n\nYou can [`read`](crate::Reg::read) this register and get [`cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cfg`]
module"]
#[doc(alias = "CFG")]
...
#[doc = "FIFOSTAT (rw) register accessor: This register contains status of the data FIFO.\n\nYou can [`read`](crate::Reg::read) this register and get [`fifostat::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fifostat::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fifostat`]
module"]
#[doc(alias = "FIFOSTAT")]
pub type Fifostat = crate::Reg<fifostat::FifostatSpec>;
#[doc = "This register contains status of the data FIFO."]
pub mod fifostat;
#[doc = "DATAOFFSET (rw) register accessor: ERROR: reg_brief VALUE MISSING\n\nYou can [`read`](crate::Reg::read) this register and get [`dataoffset::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dataoffset::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dataoffset`]
module"]
#[doc(alias = "DATAOFFSET")]
pub type Dataoffset = crate::Reg<dataoffset::DataoffsetSpec>;
