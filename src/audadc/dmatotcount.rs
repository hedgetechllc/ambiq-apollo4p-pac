...
pub type TotcountR = crate::FieldReader<u16>;
#[doc = "Field `TOTCOUNT` writer - Total Transfer Count"]
pub type TotcountW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 2:17 - Total Transfer Count"]
    #[inline(always)]
    pub fn totcount(&self) -> TotcountR {
        TotcountR::new(((self.bits >> 2) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 2:17 - Total Transfer Count"]
