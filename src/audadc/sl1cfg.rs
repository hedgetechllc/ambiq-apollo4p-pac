...
#[doc = "This bit enables slot 1 for AUDADC conversions.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Slen1 {
    #[doc = "1: Enable slot 1 for AUDADC conversions."]
    Slen = 1,
    #[doc = "0: Disable slot 1 for AUDADC conversions."]
    Sldis = 0,
}
...
#[doc = "Field `SLEN1` reader - This bit enables slot 1 for AUDADC conversions."]
...
impl Slen1R {
    ...
    #[doc = "Enable slot 1 for AUDADC conversions."]
    #[inline(always)]
    pub fn is_slen(&self) -> bool {
        *self == Slen1::Slen
    }
    #[doc = "Disable slot 1 for AUDADC conversions."]
    #[inline(always)]
    pub fn is_sldis(&self) -> bool {
        *self == Slen1::Sldis
    }
}
#[doc = "Field `SLEN1` writer - This bit enables slot 1 for AUDADC conversions."]
...
#[doc = "Field `TRKCYC1` reader - Set additional input signal sampling/tracking time to the specified number of AUDADC clock cycles. (Note that a value of 0 in this register specifies the minimum required 5 cycles. A maximum of 64 specifies 69 cycles.)"]
pub type Trkcyc1R = crate::FieldReader;
#[doc = "Field `TRKCYC1` writer - Set additional input signal sampling/tracking time to the specified number of AUDADC clock cycles. (Note that a value of 0 in this register specifies the minimum required 5 cycles. A maximum of 64 specifies 69 cycles.)"]
...
impl R {
    #[doc = "Bit 0 - This bit enables slot 1 for AUDADC conversions."]
    #[inline(always)]
