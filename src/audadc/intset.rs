...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnvcmp(&mut self) -> CnvcmpW<IntsetSpec> {
        CnvcmpW::new(self, 0)
    }
    #[doc = "Bit 1 - AUDADC scan complete interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn scncmp(&mut self) -> ScncmpW<IntsetSpec> {
        ScncmpW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO 75 percent full interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fifoovr1(&mut self) -> Fifoovr1W<IntsetSpec> {
        Fifoovr1W::new(self, 2)
    }
    #[doc = "Bit 3 - FIFO 100 percent full interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fifoovr2(&mut self) -> Fifoovr2W<IntsetSpec> {
        Fifoovr2W::new(self, 3)
    }
    #[doc = "Bit 4 - Window comparator voltage excursion interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn wcexc(&mut self) -> WcexcW<IntsetSpec> {
        WcexcW::new(self, 4)
    }
    #[doc = "Bit 5 - Window comparator voltage incursion interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn wcinc(&mut self) -> WcincW<IntsetSpec> {
        WcincW::new(self, 5)
    }
    #[doc = "Bit 6 - DMA Transfer Complete"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn zxca(&mut self) -> ZxcaW<IntsetSpec> {
        ZxcaW::new(self, 8)
    }
    #[doc = "Bit 9 - Zero Crossing - Channel B (Slots 2 or 3)"]
    #[inline(always)]
    #[must_use]
    pub fn zxcb(&mut self) -> ZxcbW<IntsetSpec> {
        ZxcbW::new(self, 9)
    }
    #[doc = "Bit 10 - Saturation - Channel A (Slots 0 or 1)"]
    #[inline(always)]
    #[must_use]
    pub fn satca(&mut self) -> SatcaW<IntsetSpec> {
        SatcaW::new(self, 10)
    }
    #[doc = "Bit 11 - Saturation - Channel B (Slots 2 or 3)"]
    #[inline(always)]
    #[must_use]
    pub fn satcb(&mut self) -> SatcbW<IntsetSpec> {
        SatcbW::new(self, 11)
    }
}
