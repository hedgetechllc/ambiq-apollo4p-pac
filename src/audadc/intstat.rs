...
#[doc = "AUDADC conversion complete interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cnvcmp {
    #[doc = "1: AUDADC conversion complete interrupt."]
    Cnvcmpint = 1,
    #[doc = "0: No AUDADC conversion complete interrupt."]
    Cnvcmpnoint = 0,
}
...
#[doc = "Field `CNVCMP` reader - AUDADC conversion complete interrupt."]
...
impl CnvcmpR {
    ...
    #[doc = "No AUDADC conversion complete interrupt."]
    #[inline(always)]
    pub fn is_cnvcmpnoint(&self) -> bool {
        *self == Cnvcmp::Cnvcmpnoint
    }
}
#[doc = "Field `CNVCMP` writer - AUDADC conversion complete interrupt."]
...
#[doc = "AUDADC scan complete interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Scncmp {
    #[doc = "1: AUDADC scan complete interrupt."]
    Scncmpint = 1,
    #[doc = "0: No AUDADC scan complete interrupt."]
    Scncmpnoint = 0,
}
...
#[doc = "Field `SCNCMP` reader - AUDADC scan complete interrupt."]
...
impl ScncmpR {
    ...
    #[doc = "No AUDADC scan complete interrupt."]
    #[inline(always)]
    pub fn is_scncmpnoint(&self) -> bool {
        *self == Scncmp::Scncmpnoint
    }
}
#[doc = "Field `SCNCMP` writer - AUDADC scan complete interrupt."]
...
impl R {
    #[doc = "Bit 0 - AUDADC conversion complete interrupt."]
    #[inline(always)]
    pub fn cnvcmp(&self) -> CnvcmpR {
        CnvcmpR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - AUDADC scan complete interrupt."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnvcmp(&mut self) -> CnvcmpW<IntstatSpec> {
        CnvcmpW::new(self, 0)
    }
    #[doc = "Bit 1 - AUDADC scan complete interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn scncmp(&mut self) -> ScncmpW<IntstatSpec> {
        ScncmpW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO 75 percent full interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fifoovr1(&mut self) -> Fifoovr1W<IntstatSpec> {
        Fifoovr1W::new(self, 2)
    }
    #[doc = "Bit 3 - FIFO 100 percent full interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn fifoovr2(&mut self) -> Fifoovr2W<IntstatSpec> {
        Fifoovr2W::new(self, 3)
    }
    #[doc = "Bit 4 - Window comparator voltage excursion interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn wcexc(&mut self) -> WcexcW<IntstatSpec> {
        WcexcW::new(self, 4)
    }
    #[doc = "Bit 5 - Window comparator voltage incursion interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn wcinc(&mut self) -> WcincW<IntstatSpec> {
        WcincW::new(self, 5)
    }
    #[doc = "Bit 6 - DMA Transfer Complete"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn zxca(&mut self) -> ZxcaW<IntstatSpec> {
        ZxcaW::new(self, 8)
    }
    #[doc = "Bit 9 - Zero Crossing - Channel B (Slots 2 or 3)"]
    #[inline(always)]
    #[must_use]
    pub fn zxcb(&mut self) -> ZxcbW<IntstatSpec> {
        ZxcbW::new(self, 9)
    }
    #[doc = "Bit 10 - Saturation - Channel A (Slots 0 or 1)"]
    #[inline(always)]
    #[must_use]
    pub fn satca(&mut self) -> SatcaW<IntstatSpec> {
        SatcaW::new(self, 10)
    }
    #[doc = "Bit 11 - Saturation - Channel B (Slots 2 or 3)"]
    #[inline(always)]
    #[must_use]
    pub fn satcb(&mut self) -> SatcbW<IntstatSpec> {
        SatcbW::new(self, 11)
    }
}
