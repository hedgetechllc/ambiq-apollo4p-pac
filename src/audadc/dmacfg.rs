...
#[doc = "Field `DPWROFF` reader - Power Off the AUDADC System upon DMACPL."]
pub type DpwroffR = crate::BitReader;
#[doc = "Field `DPWROFF` writer - Power Off the AUDADC System upon DMACPL."]
...
impl R {
    ...
    #[doc = "Bit 18 - Power Off the AUDADC System upon DMACPL."]
    #[inline(always)]
