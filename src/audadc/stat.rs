...
#[doc = "Indicates the power-status of the AUDADC.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Pwdstat {
    #[doc = "0: Powered on."]
    On = 0,
    #[doc = "1: AUDADC Low Power Mode 1."]
    PoweredDown = 1,
}
...
#[doc = "Field `PWDSTAT` reader - Indicates the power-status of the AUDADC."]
...
impl PwdstatR {
    ...
    #[doc = "AUDADC Low Power Mode 1."]
    #[inline(always)]
    pub fn is_powered_down(&self) -> bool {
        *self == Pwdstat::PoweredDown
    }
}
#[doc = "Field `PWDSTAT` writer - Indicates the power-status of the AUDADC."]
...
impl R {
    #[doc = "Bit 0 - Indicates the power-status of the AUDADC."]
    #[inline(always)]
