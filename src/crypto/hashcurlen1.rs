#[doc = "Register `HASHCURLEN1` reader"]
pub type R = crate::R<Hashcurlen1Spec>;
#[doc = "Register `HASHCURLEN1` writer"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn length(&mut self) -> LengthW<Hashcurlen1Spec> {
        LengthW::new(self, 0)
    }
}
#[doc = "This register holds the length of current hash operation bit 63:32.\n\nYou can [`read`](crate::Reg::read) this register and get [`hashcurlen1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hashcurlen1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hashcurlen1Spec;
impl crate::RegisterSpec for Hashcurlen1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hashcurlen1::R`](R) reader structure"]
impl crate::Readable for Hashcurlen1Spec {}
#[doc = "`write(|w| ..)` method takes [`hashcurlen1::W`](W) writer structure"]
impl crate::Writable for Hashcurlen1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HASHCURLEN1 to value 0"]
