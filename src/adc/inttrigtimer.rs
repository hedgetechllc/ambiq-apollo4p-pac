...
#[doc = "ADC-internal trigger timer enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Timeren {
    #[doc = "0: Disable the ADC-internal trigger timer."]
    Dis = 0,
    #[doc = "1: Enable the ADC-internal trigger timer."]
    En = 1,
}
...
#[doc = "Field `TIMEREN` reader - ADC-internal trigger timer enable."]
...
impl TimerenR {
    ...
    #[doc = "Disable the ADC-internal trigger timer."]
    #[inline(always)]
    pub fn is_dis(&self) -> bool {
        *self == Timeren::Dis
    }
    #[doc = "Enable the ADC-internal trigger timer."]
    #[inline(always)]
    pub fn is_en(&self) -> bool {
        *self == Timeren::En
    }
}
#[doc = "Field `TIMEREN` writer - ADC-internal trigger timer enable."]
...
impl R {
    ...
    #[doc = "Bit 31 - ADC-internal trigger timer enable."]
    #[inline(always)]
