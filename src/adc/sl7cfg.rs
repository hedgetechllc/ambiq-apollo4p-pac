...
pub enum Slen7 {
    ...
    Slen = 1,
    #[doc = "0: Disable slot 7 for ADC conversions."]
    Sldis = 0,
}
...
impl Slen7R {
    ...
    #[doc = "Disable slot 7 for ADC conversions."]
    #[inline(always)]
...
#[doc = "Field `CHSEL7` reader - Select one of the 11 channel inputs for this slot."]
...
#[doc = "Field `CHSEL7` writer - Select one of the 11 channel inputs for this slot."]
...
#[doc = "Field `TRKCYC7` reader - Set additional input signal sampling/tracking time to the specified number of ADC clock cycles. (Note that a value of 0 in this register specifies the minimum required 5 cycles. A maximum of 64 specifies 69 cycles.)"]
pub type Trkcyc7R = crate::FieldReader;
#[doc = "Field `TRKCYC7` writer - Set additional input signal sampling/tracking time to the specified number of ADC clock cycles. (Note that a value of 0 in this register specifies the minimum required 5 cycles. A maximum of 64 specifies 69 cycles.)"]
